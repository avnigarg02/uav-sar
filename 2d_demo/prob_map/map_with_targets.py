...
target_positions = np.random.randint(0, grid_size, size=(10, 2))  # 10 targets with random positions

# Plot the targets on the map
targets = [ax.plot(*target_position, 'bo')[0] for target_position in target_positions]
...
ani.save('2d_demo/prob_map/map_with_targets.gif')
